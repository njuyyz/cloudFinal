...
public class PublicActivity extends Activity implements OnTouchListener, OnPositionChangedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout barLayout = (RelativeLayout) PublicActivity.this.findViewById(R.id.qa_bar);
...
//        v.setOnTouchListener(this);
    ...
    private void initMessages() {
        // set header
        messages.add(new ActivityMessage("me","boss","http://m.c.lnkd.licdn.com/mpr/mprx/0_q6hJ9Gmt7Fs09Re19b1o9TstSTY1nZZ1n3qQ9TyatkEGWp7PZhrzZ3Hh_fODzxM0zLGFJ6GmTJ-b",1333153510605l));
